...
export { parse, parseEventAttribute, parseRefOrRead, parseWithErrors, ParseError } from "@interactable/parser.ts";
export type {
  Arg,
  Call,
  EventAttribute,
  EventValueDeclaration,
  Modifier,
  ParseResult,
  Phrase,
  Ref,
